...
This project uses third-party fonts and software dependencies.
All are redistributed in accordance with their respective licenses.
...
Emoji fonts are licensed under the SIL Open Font License, Version 1.1.
Tools and most image resources are licensed under the Apache License, Version 2.0.
Flag images under third_party/region-flags are in the public domain or otherwise
...
This font also incorporates:
  - Roboto v2.138 (Copyright Google) — Apache License, Version 2.0
...
================================================================================
Rust Crate Dependencies (MPL-2.0)
================================================================================

The following Rust crate dependencies are licensed under the Mozilla Public
License, Version 2.0. These are indirect dependencies pulled in by the Tauri
framework. Their source code has not been modified by this project.

Per MPL-2.0 Section 3.3, this project (as a "Larger Work") is distributed
under the MIT License, which is permitted by the MPL-2.0.

  - cssparser 0.29.6, 0.36.0 — CSS parser (Servo project)
  ...
  - dtoa-short 0.3.5 — Short floating-point to string conversion
    Copyright: The dtoa-short Authors
    License: MPL-2.0

  - dwrote 0.11.5 — Windows DirectWrite API bindings
    Copyright: The Mozilla Foundation
    License: MPL-2.0

  - option-ext 0.2.0 — Extension trait for Option
    Copyright: The option-ext Authors
    License: MPL-2.0

  - selectors 0.24.0, 0.35.0 — CSS selector matching engine (Servo project)
    Copyright: The Servo Project Developers
    License: MPL-2.0

See "MOZILLA PUBLIC LICENSE" section below for full license text.
...
4. Inability to Comply Due to Statute or Regulation
    ...
    under the name "LEGAL", and included in all source code or executable
    form distributions. Contents of the LEGAL file are for informational
    purposes only and do not alter the License.
